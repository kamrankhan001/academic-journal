...
@section('page-content')
    <div class="prose prose-sm max-w-none text-gray-600">
        ...
        <section class="mb-8">
            ...
            <h3 class="font-semibold text-gray-800 mb-2">Personal Data</h3>
            <p class="mb-4">
        ...
        <section class="mb-8">
            <h2 class="text-xl font-bold text-gray-800 mb-3">4. Cookies and Tracking Technologies</h2>
            <p class="mb-4">
        ...
        <section class="mb-8">
            <h2 class="text-xl font-bold text-gray-800 mb-3">8. Changes to This Privacy Policy</h2>
            <p class="mb-4">
