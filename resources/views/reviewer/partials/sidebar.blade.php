...
<aside id="sidebar"
    ...
    <div class="h-full flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            ...
            <ul class="space-y-1 px-3 mb-6">
                ...
                <li>
                    <a href="{{ route('reviewer.dashboard') }}"
                        ...
                        <i
                            class="fa-solid fa-chart-pie w-5 text-gray-400 group-hover:text-[#86662c] {{ $currentRoute === 'reviewer.dashboard' ? 'text-[#86662c]' : '' }}"></i>
            ...
            <!-- Section 2: Reviews -->
            <div class="px-3 mb-2">
                <p class="text-xs font-semibold text-gray-400 uppercase tracking-wider">Reviews</p>
            </div>
            <ul class="space-y-1 px-3 mb-6">
                <!-- My Reviews -->
                <li>
                    <a href="{{ route('reviewer.assignments.index') }}"
                        ...
                        <i
                            class="fa-solid fa-file-lines w-5 text-gray-400 group-hover:text-[#86662c] {{ str_starts_with($currentRoute, 'reviewer.assignments') ? 'text-[#86662c]' : '' }}"></i>
            ...
            <ul class="space-y-1 px-3 mb-6">
                ...
                <li>
                    <a href="{{ route('reviewer.notifications.index') }}"
                        ...
                        <i class="fa-solid fa-bell w-5 text-gray-400 group-hover:text-[#86662c] {{ request()->routeIs('reviewer.notifications*') ? 'text-[#86662c]' : '' }}"></i>
                ...
                <li>
                    <a href="{{ route('reviewer.profile') }}"
                        ...
                        <i
                            class="fa-solid fa-user w-5 text-gray-400 group-hover:text-[#86662c] {{ $currentRoute === 'reviewer.profile' ? 'text-[#86662c]' : '' }}"></i>
